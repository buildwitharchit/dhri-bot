...
from handlers.concept import handle_concept
from handlers.doubt import handle_doubt
...
from handlers.practice.rc import start_rc_session
from handlers.practice.va import show_va_menu
from handlers.resume import handle_resume
from handlers.stats import handle_stats
from memory.session import clear_state, get_state
from handlers.practice.common import close_session
...
async def route_command(update: Update, command: str, args: str, ptb_app, tg_id: int) -> None:
    ...
    if command == "rc":
        ...
        from handlers.home import show_home as _show_home
